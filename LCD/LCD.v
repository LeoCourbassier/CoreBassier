...
-- LCD string is an ASCII character string entered in hex for 
-- the two lines of the  LCD Display   (See ASCII to hex table below)
-- Edit display_string entries above to modify display
-- Enter the ASCII character's 2 hex digit equivalent value
-- (see table below for ASCII hex values)
-- To display character assign ASCII value to display_string(x)
...
module LCD(iCLK_50MHZ, iRST_N, hex0, hex1, hex2, hex3, hex4, hex5,
...
module display_string(index,out,hex5,hex4,hex3,hex2,hex1,hex0);
input [4:0] index;
